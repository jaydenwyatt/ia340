...
--q2.5
--insert professor first because professors table comes first
insert into professor(p_email, p_name, office)
...
--q2.6
--Course table gets changed first because you wouldnt be able to delete p1, need to use update and delete
update course 
